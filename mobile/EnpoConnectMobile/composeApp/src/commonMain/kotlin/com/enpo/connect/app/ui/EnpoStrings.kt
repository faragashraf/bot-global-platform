...
data class EnpoStrings(
    ...
    val loading: String,
    val welcome: String,
    val linkedAndSecure: String,
    val authenticationRequests: String,
    val noAuthenticationRequests: String,
    val communications: String,
    val communicationsBody: String,
    val security: String,
    ...
    val enableNotificationsBody: String,
    val enpoSounds: String,
    val profile: String,
    val notificationInboxSubtitle: String,
    val noNotifications: String,
    val unread: String,
    val read: String,
    val highPriority: String,
    val normalPriority: String,
    ...
    val appearanceAndLanguage: String,
    val about: String,
    val deviceAndPairing: String,
    val deviceStatus: String,
    val pairingInformation: String,
    val pairedAndSecure: String,
    val profileUnavailable: String,
    val profileUnavailableBody: String,
    val jobTitle: String,
    val organizationUnit: String,
    val profileLoadError: String,
    val profileLoadErrorBody: String,
    val profileAuthenticationRequired: String,
    val pairingMode: String,
    val productionPublicService: String,
    val credentialStorage: String,
    val encryptedAndAvailable: String,
    val arabic: String,
    val english: String,
    val system: String,
    val light: String,
    ...
    fun allValues(): List<String> = listOf(
        ...
        profileAuthenticationRequired,
        pairingMode,
        productionPublicService,
        credentialStorage,
        encryptedAndAvailable,
        arabic,
        english,
        system,
        light,
...
private val ArabicStrings = EnpoStrings(
    ...
    welcome = "مرحباً بك",
    linkedAndSecure = "الجهاز مرتبط وآمن",
    authenticationRequests = "طلبات المصادقة",
    noAuthenticationRequests = "لا توجد طلبات مصادقة حالياً",
    communications = "التعليمات والإشعارات",
    communicationsBody = "ستظهر هنا التعليمات الرسمية والتنبيهات المهمة الواردة من الجهة.",
    security = "الأمان والحماية",
    securityBody = "يمكنك إدارة حماية التطبيق والجهاز من شاشة الإعدادات.",
    ...
    sliceNotice = "الجهاز مرتبط وجاهز لاستقبال إشعارات ENPO Connect.",
    settings = "الإعدادات",
    notifications = "الإشعارات",
    notificationSettings = "إعدادات الإشعارات",
    enableNotifications = "تفعيل الإشعارات",
    enableNotificationsBody = "استقبال التنبيهات والتعليمات الرسمية",
    enpoSounds = "أصوات ENPO Connect",
    profile = "الملف الشخصي",
    notificationInboxSubtitle = "التعليمات والتنبيهات الواردة من الجهة",
    ...
    openAction = "فتح الرابط",
    notificationDetails = "تفاصيل الإشعار",
    language = "اللغة",
    appearance = "المظهر",
    appearanceAndLanguage = "المظهر واللغة",
    about = "حول التطبيق",
    deviceAndPairing = "الجهاز والاقتران",
    deviceStatus = "حالة الجهاز",
    pairingInformation = "معلومات الاقتران",
    pairedAndSecure = "مقترن وآمن",
    profileUnavailable = "بيانات الملف الشخصي غير متاحة بعد",
    profileUnavailableBody = "لم تنشر منصة Connect بيانات ملفك إلى Bot Global بعد.",
    jobTitle = "المسمى الوظيفي",
    organizationUnit = "الوحدة التنظيمية",
    profileLoadError = "تعذر تحميل الملف الشخصي",
    profileLoadErrorBody = "تعذر الوصول إلى Bot Global. تحقق من الاتصال ثم حاول مرة أخرى.",
    profileAuthenticationRequired = "بيانات اقتران الجهاز غير صالحة أو تم إلغاؤها.",
    pairingMode = "وضع الاقتران",
    productionPublicService = "إنتاج - Public Service",
    credentialStorage = "بيانات اعتماد الجهاز",
    encryptedAndAvailable = "مشفرة ومتاحة",
    arabic = "العربية",
    english = "English",
    system = "النظام",
    light = "فاتح",
    ...
    deferredCapabilitiesBody = "حماية التطبيق وإلغاء الربط الكامل مؤجلان.",
)
...
private val EnglishStrings = EnpoStrings(
    ...
    loading = "Loading...",
    welcome = "Welcome",
    linkedAndSecure = "Device linked and secure",
    authenticationRequests = "Authentication requests",
    noAuthenticationRequests = "There are no authentication requests right now",
    communications = "Instructions & notifications",
    communicationsBody = "Official instructions and important organization alerts will appear here.",
    security = "Security & protection",
    securityBody = "Manage app and device protection from Settings.",
    foundationEyebrow = "CONNECT",
    ...
    sliceNotice = "This paired device is ready to receive ENPO Connect notifications.",
    settings = "Settings",
    notifications = "Notifications",
    notificationSettings = "Notification settings",
    enableNotifications = "Enable notifications",
    enableNotificationsBody = "Receive official alerts and instructions",
    enpoSounds = "ENPO Connect sounds",
    profile = "Profile",
    notificationInboxSubtitle = "Instructions and alerts from your organization",
    ...
    about = "About",
    deviceAndPairing = "Device & pairing",
    deviceStatus = "Device status",
    pairingInformation = "Pairing information",
    pairedAndSecure = "Paired and secure",
    profileUnavailable = "Profile not available yet",
    profileUnavailableBody = "Connect has not published your profile to Bot Global yet.",
    jobTitle = "Job title",
    organizationUnit = "Organization unit",
    profileLoadError = "Profile could not be loaded",
    profileLoadErrorBody = "Bot Global could not be reached. Check your connection and try again.",
    profileAuthenticationRequired = "The device pairing credential is invalid or has been revoked.",
    pairingMode = "Pairing mode",
    productionPublicService = "Production - Public Service",
    credentialStorage = "Device credential",
    encryptedAndAvailable = "Encrypted and available",
    arabic = "العربية",
    english = "English",
    system = "System",
    light = "Light",
    ...
    deferredCapabilitiesBody = "App Protection and full unpair remain deferred.",
)
