...
private val ArabicStrings = EnpoStrings(
    ...
    profileUnavailable = "بيانات الملف الشخصي",
    profileUnavailableBody = "سيتم عرض بيانات ملفك من Connect بعد اكتمال مرحلة ترحيل الملف الشخصي.",
    ...
    deferredCapabilitiesBody = "بيانات الملف الشخصي وحماية التطبيق وإلغاء الربط الكامل مؤجلة.",
)
...
private val EnglishStrings = EnpoStrings(
    ...
    profileUnavailable = "Profile information",
    profileUnavailableBody = "Your Connect profile will appear here after the profile migration slice is complete.",
    ...
    deferredCapabilitiesBody = "Profile data, App Protection, and full unpair remain deferred.",
)
